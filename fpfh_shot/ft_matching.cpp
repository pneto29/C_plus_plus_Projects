...
int main(int, char** argv)
{
    ...
    loadPCDFile(argv[1], *source_cloud);
...
//Target Point Cloud
    ...
    loadPCDFile(argv[2], *target_cloud);
    ...
    iss_detector_1.setSalientRadius(6 * model_resolution_1);
    iss_detector_1.setNonMaxRadius(4 * model_resolution_1);
    iss_detector_1.setThreshold21(0.975);
    iss_detector_1.setThreshold32(0.975);
    iss_detector_1.setMinNeighbors(5);
    iss_detector_1.setNumberOfThreads(1);
...
// estimate correspondences
    ...
    ICPView.addPointCloud<pcl::PointXYZ>(target_cloud, handler_target_cloud, "target_cloud");
